...
if __name__ == "__main__":
    ...
    eval_cfg = SimpleNamespace(
        ...
        ckpt_path="outputs/2_pretrain/SewNeedle-3Arms-v0/2026-07-26/01-03-50_SewNeedle-3Arms-v0_pre_zed_diffusion/checkpoints/166000_loss=0.0014_sr=66.0_ar=703.21",
        ...
        action_steps=[ 4,6,8,10,12,14],  # 每次策略推理后连续执行的动作数；所有值使用相同 episode seeds
