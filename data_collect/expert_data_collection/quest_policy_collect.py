...
for path in (ROOT_DIR, DATA_COLLECT_DIR, CURRENT_DIR):
...
from data_collect.expert_data_collection.collection_run_state import ExclusiveRunLock, atomic_write_json
...
from data_collect.expert_data_collection.quest_teleop_collect import (
